...
//
//
// retourne le nb de tuiles
//
int getTilesCoord(const char *movie_filename,vector4 lut_bb,tile_info* tiles, int maxNbTile,int lut_bb_pixels[4]);
